...
CF_X = io.loadmat('PAC12195_X.mat')['MLHM2_X']
assert CF_X.shape[0] == 195
...
CF_Y = io.loadmat('PAC12195_Y.mat')['label']
assert CF_X.shape[0] == 195
...
for D in components:
    for alpha in alphas:
        ...
        savemat('PAC12_MPSR_prediction.mat', {'Y_test': Y_test, 'Y_pred': Y_predict_test_base})
