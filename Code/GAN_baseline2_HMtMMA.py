...
Dir_data_Y_MPS = 'G:\\Shared drives\\Head Models (KTH, GHBMC, ML)\\ML\\Training Dataset\\MLHM2 Y\\MPS'
...
for D in components:
    for alpha in alphas:
        ...
        Adam = optimizers.Adam(lr = lr, decay=5e-8)
        model.fit(X_std_aug, Y_std_aug, epochs=epoch, batch_size=512, verbose=True)
        ...
        savemat('HM2MMA_MPS_DRCA_lr_0.001_epoch_300_components_400_alpha_100.mat',{'True': Y_test,'Prediction':Y_predict_test_base})
